...
spmi1_R={[]};spmi1_L={[]};
 ...
 yR{i,1}       = elderly_metadata(i).GRF_R_corrFilter97{1, 1}{1, d};
 yL{i,1}       = elderly_metadata(i).GRF_L_corrFilter97{1, 1}{1, d};

% mu0     = 0;    %null criterion
% mu1     = 5 * sin( linspace(0, pi, size(yR{i,1},2)) );  %arbitrary criterion 
