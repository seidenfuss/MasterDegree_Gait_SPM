function [spm,spmi,spm_sidak,spmi_sidak] = hotellingT2_posthoc_paired(data,label_part)
...
xlabel("Stance Phase (%)");
sgtitle(strcat(label_part, '- GRF Walking - GaitRec Nature Database'))
...
for d=1:3
    ...
    sgtitle(strcat(label_part,'- GaitRec Nature Database: Post-hoc - Šidák p-value: 0.0170'))
end
end
end
