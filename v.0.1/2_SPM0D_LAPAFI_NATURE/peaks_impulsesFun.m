function [discrete_GRF] = peaks_impulsesFun(data,string1,string2)
...
for l=1:3
    for i=1:dim(1,2)
GRF{i,l}=data(i).mean_GRF_RL{1, l};  
    end
end
...
limite=[0.3,1.5,0.3];
 ...
 figure()
     for i =1:dim(1,2)
        subplot(2,6,i)
        plot(data(i).mean_GRF_RL{1, d}  , 'color', 'k'); hold on;  plot([0 100], [0 0], 'k:');
        if d==1
        hold on
