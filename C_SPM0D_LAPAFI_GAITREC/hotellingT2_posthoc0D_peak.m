...
%(1) first valley anterior posterior  force (discrete_GRF.min_AP_R)
%(2) first peak vertical force (discrete_GRF.peak1_V_R)
%(3) first valley lateral force (discrete_GRF.valley1_ML_R)
...
for i=1:dim
    ...
    yA(i,3)=data1(i).valley1_ML_RL;
    
    yB(i,1)=data2(i).min_AP_RL;
    yB(i,2)=data2(i).peak1_V_RL;
    yB(i,3)=data2(i).valley1_ML_RL;
end
