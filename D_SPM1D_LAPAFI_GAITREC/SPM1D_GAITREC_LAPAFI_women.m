...
[results.GAITREC.spm.young_olderAdult,results.GAITREC.spmi.young_olderAdult,results.GAITREC.spm_sidak.young_olderAdult,results.GAITREC.spmi_sidak.young_olderAdult] = hotellingT2_posthoc(GAITREC_women12.young,GAITREC_women12.olderAdult,'GAITREC: Young vs Older Adult Women','young','SD young','olderAdult','SD olderAdult');
[results.GAITREC.spm.adult_olderAdult,results.GAITREC.spmi.adult_olderAdult,results.GAITREC.spm_sidak.adult_olderAdult,results.GAITREC.spmi_sidak.adult_olderAdult] = hotellingT2_posthoc(GAITREC_women12.adult,GAITREC_women12.olderAdult,'GAITREC: Adult vs Older Adult Women','adult','SD adult','olderAdult','SD olderAdult');
